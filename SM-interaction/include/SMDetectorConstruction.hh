...
#ifndef SMDetectorConstruction_h
#define SMDetectorConstruction_h 1
...
class SMDetectorConstruction : public G4VUserDetectorConstruction {
public:
  SMDetectorConstruction();
  virtual ~SMDetectorConstruction();
