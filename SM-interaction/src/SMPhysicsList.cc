...
SMPhysicsList::SMPhysicsList(G4int verbose) : G4VModularPhysicsList() {
...
//  RegisterPhysics( new G4HadronElasticPhysics);
  ...
  RegisterPhysics( new G4IonQMDPhysics);
}

SMPhysicsList::~SMPhysicsList() {;}

// These values are used as the default production thresholds
// for the world volume.

void SMPhysicsList::ConstructParticle()
{
...
/*
void SMPhysicsList::ConstructProcess()
{
