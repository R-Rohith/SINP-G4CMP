...
SMDetectorConstruction::SMDetectorConstruction()
...
G4VPhysicalVolume* SMDetectorConstruction::Construct()
{
  if (fConstructed) {
...
void SMDetectorConstruction::ConstructSDandField() {

  G4SDManager* SDman = G4SDManager::GetSDMpointer();
 
  SMSensitivity* electrodeSD
    = new SMSensitivity("PhononElectrode");
...
void SMDetectorConstruction::DefineMaterials()
{ 
...
void SMDetectorConstruction::SetupGeometry()
{
  //     
  // World
  //
