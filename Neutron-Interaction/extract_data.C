...
//        TH1D *lfactor_hist = new TH1D("","Lindhard factor ditribution; Lindhard factor;Events",100,0,1);
        ...
        vertex_hist->SetTitle("Distribution of primary vertex of neutrons; x (cm);y (cm);z (cm)");
...
//        temp_vs_z_hist->Sumw2();
	...
	while(rootfilelist>>rootfilename)
	{
		...
		double depE,W,posx,posy,posz,ftime,Esum=0,bigtime=0,smalltime=6e33,count=0,Wcount=0;
...
//		vector<double> DepE_arr;
	...
	fin->WriteObject(energy_hist,"Primary particle energy");
