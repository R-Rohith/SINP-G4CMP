...
class DetectorConstruction : public G4VUserDetectorConstruction
{
 public:
  ...
  void AddMirrorProperty(const G4String& prop, G4MaterialPropertyVector* mpv);
  // void AddSurfaceMPC(const G4String& prop, G4double v);
  G4MaterialPropertiesTable* GetMirrorSurfaceMaterialPropertiesTable()
  {
    return fMirrorSurfaceMPT;
  }
 ...
 private:
  ...
  G4Material* fCaWO4; // For Crystal
  G4OpticalSurface* fSurface;
  G4OpticalSurface* fMirrorSurface; // For Reflecting surface
  ...
  G4MaterialPropertiesTable* fMirrorSurfaceMPT; // For Reflecting surface
};
